...
exports.run = async (bot, message, args) => {
    ...
    if (rMember.roles.has(aRole.id)) return message.channel.sendEmbed(new Discord.RichEmbed().setDescription('Zaten bu rol mevcut!').setColor(10038562));
