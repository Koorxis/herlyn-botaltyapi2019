...
var palstation = "https://www.canli-radyo.biz/2013/07/pal-station.html";
...
if(!mesaj) {
	message.reply("Lütfen Herhangi Bir Radyo Numarası Seçiniz. (radyo sistemi geliştirme aşamasındadır.)\n\n__Radyo Kanalları__\n\n**[1] - JoyTürk**\n**[2] - SlowTürk**\n**[3] - Fenomen FM**\n**[4] - Metro**\n**[5] - Number1 FM**\n**[6] - PowerTürk**\n**[7] - PalStation**\n\n\nÖrnek = **" + prefix + "radyo**\nVe Ardından Sayı\nÖrnek = **" + prefix + "radyo 2**\nCodAre Mustafa Arda Gelişmiş Türk Radyo Sistemi")
}		
    ...
    if(mesaj === "7") {
        ...
        .then(connection => {
            const dispatcher = connection.playStream(number1);
            return message.channel.send("**PalStation** FM Oynatılıyor.");
        }));
        return;
    }; 
    // 14
